...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            var marker = L.marker([41.3111, 69.27975],
            {alt: 'Amir Temur Square'}).addTo(map)
            .bindPopup(`
                <div id="popup-content">
                    <table id="popup-table">
                    <tr>
                        <td><label for="name" class="label-name"></label><span class="content-name">Name</span></td>
                        <td><input name="name" type="text" value="Amir Temur Square" required disabled></td>
                    </tr>
                    <tr>
                        <td><label for="area" class="label-name"></label><span class="content-name">Area (ha)</span></td>
                        <td><input name="area" type="number" value="1" required disabled></td>
                    </tr>
                    <tr>
                        <td><label for="description"></label><span class="content-name">Description</span></td>
                        <td><textarea name="description" type="text" required disabled>This is a place where many marginal and hipster youths gather to perform their anti-social behaviour and,  sometimes, even commit to crimes</textarea></td>
                    </tr>
                    </table>
                </div>`);
