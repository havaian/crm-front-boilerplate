...
<script>
    ...
    // import buildingsModel from '../models/buildings_model';
    ...
    // mongoose.connect('mongodb+srv://db_admin:nZb2Q4IfpSL5SNmg@cluster0.zgrtw.mongodb.net/BookStore?retryWrites=true&w=majority');
    // console.log('MongoDB ✅\nMongoose ✅');
